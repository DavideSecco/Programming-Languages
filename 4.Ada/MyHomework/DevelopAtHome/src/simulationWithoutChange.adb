...
procedure Simulation is
   ...
   subtype Consumer_Type is Integer range 1 .. Number_of_Consumers;        -- part type is a integer type from 1 to 2
	...
	Part_Name: constant array (Part_Type) of String(1 .. 6):= ("Water ", "Flour ", "Salt  ", "Yeast ", "Tomato");		-- it's a array composed of 5 string[5]
	Product_Name: constant array (Product_Type) of String(1 .. 8):= ("Pizza   ", "Tigelle", "Pasta");			-- it's a array composed of 3 string[8]
   ...
   task body Buffer is
      ...
      function Can_Take(Part: Part_Type) return Boolean is
		...
		begin
			...
			-- not free space In_warehouse [THIS PART IS A BIT DIFFERENT]
